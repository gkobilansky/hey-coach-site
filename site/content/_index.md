...
values:
    heading: Our values
    text: Our goal is to help coaches develop better relationships with their athletes. We believe that perfection is not when there is no more to add, but no more to take away. You should have technology that gets out of your way and lets you get back to coaching.
---
